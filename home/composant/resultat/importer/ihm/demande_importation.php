<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_resultats">Resultat</a>
	</li>
	<li class="active">
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=importer_resultats"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
			
					
					<div class="form-group">		
						<label class="col-sm-3 control-label">Resultats</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class=""></i></span>
									<input type="file" name="resultat" class="form-control" required="required">
