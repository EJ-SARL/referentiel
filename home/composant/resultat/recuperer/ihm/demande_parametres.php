<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=rechercher_resultat">Resultat</a>
	</li>
	<li class="active">
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=recuperer_resultats"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
					...
					<i class="entypo-right-open-mini">Recuperer</i>
					</div>
					</div>
