<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=supprimer_resultat">Resultat</a>
	</li>
	<li class="active">
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=supprimer_resultat"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
