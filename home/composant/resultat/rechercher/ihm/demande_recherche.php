<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_etudiants">Etudiant</a>
	</li>
	<li class="active">
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=rechercher_resultat"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
						...
						<label class="col-sm-3 control-label">Matricule </label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="matricule" class="form-control"  id="search" list="searchresults" autocomplete="off">
													...
													for($i=0; $i < count($matricule); $i++)
														{         
															echo"  
																	...
																	<option> " . $matricule[$i]->matricule."</option>                       
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<select name="session" id="session"  class="form-control">
										...
										<option value="0">0. Semestre 1</option>
										<option value="1">1. Rattrapage 1</option>                       
										<option value="2">2. Semestre 2</option>	
										<option value="2">3. Rattrapage 2</option>
										<option value="2">4. Mi-session</option>
										<option value="2">5. Première session</option>
										<option value="2">6. Deuxième session</option>	
									</select>
					...
					<i class="entypo-right-open-mini">Rechercher</i>
					</div>
					</div>
