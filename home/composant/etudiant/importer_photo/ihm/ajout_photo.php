<form method="POST" action="index.php?demande=ajouter_photo_client"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
