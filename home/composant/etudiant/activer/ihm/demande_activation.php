...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=desactivation_etudiants"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
			
					
					<div class="form-group">		
						<label class="col-sm-3 control-label">Etudiants</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class=""></i></span>
									<input type="file" name="etudiant" class="form-control" required="required">
									<span class="input-group-addon"><i style='color:green;'>Placer les matricules sur la première colonne d'Excel</i></span>
								</div>
							</div>
					</div>
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<select name="service" id="service"  class="form-control">
										<option value=0>Desactivation</option>
