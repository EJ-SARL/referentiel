...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<form method="POST" action="index.php?demande=ajouter_option"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
						...
						<label class="col-sm-3 control-label">Option</label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="option" class="form-control" placeholder="Option" required="required">
