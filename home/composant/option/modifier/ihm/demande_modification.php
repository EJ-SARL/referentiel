	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-heading">
				...
				<h2 style="text-align: center;">Modifier option </h2>

			</div>
					
			<div class="panel-body">
			
				<form method="POST" action="index.php?demande=modifier_option" id="theForm"  role="form" class="form-horizontal form-groups-bordered">
						...
						<label class="col-sm-3 control-label">Option</label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="options" value=<?php echo $options;?>  class="form-control">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
								</div>
							</div>
					</div>
