...
<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_agents">Processus</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_processus"  id="theForm"  role="form" class="form-horizontal form-groups-bordered" enctype='multipart/form-data'>
				...
				<div class="form-group">		
									...
									<select name="projet" id="projet"  class="form-control">
										...
										<?php
											for($i=0; $i < count($projets); $i++)
												{         
													echo"  
															<option value=". $projets[$i]->id ."> " . $projets[$i]->id .".  " . $projets[$i]->projet ."</option>                       
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Composant</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>


									<select name="composant" id="composant"  class="form-control">
						...
						<label class="col-sm-3 control-label" >Processus<abbr style="color:green; font-size:15px;"></abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="processus" class="form-control" placeholder="Nom du processus" required="required">
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Architecture Building bloc</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class=""></i></span>
									<input type="file" name="abb" class="form-control" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label" >Solution Building bloc<abbr style="color:green; font-size:15px;"></abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<input type="text" name="sbb" class="form-control" placeholder="Lien de code dans Github" required="required">
									<span class="input-group-addon"><i class="r"></i></span>
								</div>
							</div>
					</div>
