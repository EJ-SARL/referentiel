...
<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_titres">Titre</a>
	</li>
	<li class="active">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_cour"  id="theForm"  role="form" class="form-horizontal form-groups-bordered">
						...
						<label class="col-sm-3 control-label">Cours</label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="cours" class="form-control"  placeholder="cours" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Ponderation</label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="ponderation" class="form-control" placeholder="Ponderation" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Annee</label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="annee" class="form-control" placeholder="Annee" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Promotion</label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="promotion" class="form-control" placeholder="promotion" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
