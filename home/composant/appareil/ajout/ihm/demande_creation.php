...
<hr /><ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="?page=recuperer_appareils">Appareil</a>
	</li>
	<li class="active">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_appareil"  id="theForm"  role="form" class="form-horizontal form-groups-bordered">
						...
						<label class="col-sm-3 control-label">Nom <abbr style="color:green; font-size:15px;">**</abbr></label>
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input type="text" name="nom" class="form-control" placeholder=" nom d'appareil" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Categorie <abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="categorie" class="form-control" placeholder=" categorie d'appareil" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Numero de serie <abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="numero_serie" class="form-control" placeholder="Numero de serie d'appareil" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Place <abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="place" class="form-control" placeholder=" Place d'appareil" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Quantite <abbr style="color:green; font-size:15px;">**</abbr></label>			
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"></span>
									<input type="text" name="quantite" class="form-control" placeholder=" Quantite d'appareil" required="required">
									<span class="input-group-addon"></span>
								</div>
							</div>
					</div>
